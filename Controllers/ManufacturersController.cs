...
namespace Car_Management.Controllers
{
    ...
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ContactNo,RegisteredOffice")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ContactNo,RegisteredOffice")] Manufacturer manufacturer)
        {
